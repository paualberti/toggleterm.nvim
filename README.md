...
```lua
use {"paualberti/toggleterm.nvim", tag = '*', config = function()
...
```lua
{
  {'paualberti/toggleterm.nvim', version = "*", opts = {--[[ things you want to change go here]]}}
}
```
...
```vim
Plug 'paualberti/toggleterm.nvim', {'tag' : '*'}
